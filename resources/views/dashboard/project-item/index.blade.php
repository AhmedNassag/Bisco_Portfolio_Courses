...
@section('js')
    <script>
        $(document).ready(function () {
            /**/
            // Initialize CKEditor for the textarea elements
            let add_editors = {};
            ClassicEditor.create(document.querySelector('#store_details_ar'))
                .then(editor => {
                    add_editors['store_details_ar'] = editor;
                })
                .catch(error => {
                    console.error(error);
                });
            ClassicEditor.create(document.querySelector('#store_details_en'))
                .then(editor => {
                    add_editors['store_details_en'] = editor;
                })
                .catch(error => {
                    console.error(error);
                });
            //edit
            let edit_editors = {};
            ClassicEditor.create(document.querySelector('#update_details_ar'))
                .then(editor => {
                    edit_editors['update_details_ar'] = editor;
                })
                .catch(error => {
                    console.error(error);
                });
            ClassicEditor.create(document.querySelector('#update_details_en'))
                .then(editor => {
                    edit_editors['update_details_en'] = editor;
                })
                .catch(error => {
                    console.error(error);
                });
            ...
            $(document).on('click', '#storeBtn', function (e) {
                ...
                /**/
                // Manually update the textarea value with the CKEditor content
                for (let key in add_editors) {
                    if (add_editors.hasOwnProperty(key)) {
                        add_editors[key].updateSourceElement();
                    }
                }
                /**/
            ...
            $(document).on('click', '.updateBtn', function (e) {
                ...
                /**/
                // Manually update the textarea value with the CKEditor content
                for (let key in edit_editors) {
                    if (edit_editors.hasOwnProperty(key)) {
                        edit_editors[key].updateSourceElement();
                    }
                }
                /**/
